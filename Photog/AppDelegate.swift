...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func setupParse() {
    Parse.setApplicationId("hK21CGmr1ksIrqIyPNssOwheCvkp63viTSZSbeLg", clientKey: "pvoBtGRWS3NNhYdVUSKs3XQLcLMxyu9lDpBuQ8Kg")
  ...
  func setupAppAppearance() {
    ...
    UITabBar.appearance().selectionIndicatorImage = UIImage(named: "SelectedTabImage")
